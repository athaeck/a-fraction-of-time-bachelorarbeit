...
\newcommand{\docEmail}{nick.philipp.haecker@hs-furtwangen.de}
\newcommand{\docMatrikelnummer}{262144}

% Dokumentdaten
\newcommand{\docTitle}{Konzeption und Entwicklung eines Singleplayer Adventure Games zum Thema multidimensionale Realitäten}
...
\newcommand{\docArtDerArbeit}{Thesis zum Erlangen des Grades Bachelor of Science}
...
\newcommand{\docStudiengang}{Medieninformatik (MIB)}
\newcommand{\docAbgabedatum}{28. Februar 2023}
\newcommand{\docErsterReferent}{Prof. Jirka Dell´Oro-Friedl}
%\newcommand{\docZweiterReferent}{-} % Wenn es nur einen Betreuer gibt
\newcommand{\docZweiterReferent}{Prof. Dr. Gabriel Rausch}
