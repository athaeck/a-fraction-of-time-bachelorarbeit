...
\caption{Aktivitätsdiagramm des gesamten Spiels, (Quelle: eigene Darstellung)}
\label{fig:main_loop}
\end{figure}
...
\caption{Klassendiagramm eines Splits mit der OnTakeTimeline Methode in der CharacterController.cs, (Quelle: eigene Darstellung)}
...
\caption{Klassendiagramm eines Merges ohne OnTakeTimeline Methode in CharacterController.cs, (Quelle: eigene Darstellung)}
