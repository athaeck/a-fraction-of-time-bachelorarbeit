...
\begin{lstlisting}[caption={Split/Merge Überprüfung aus GraphController.ts Klasse}, label={fig:code-check-if-split-or-merge}]
...
\begin{lstlisting}[caption={OnRemoveOldPlaceholder aus GraphController.ts Klasse}, label={fig:on-remove-old-placeholdere}]
public class GraphController: MonoBehaviour
{
    ...
...
\begin{lstlisting}[caption={OnTimelinesToHandle aus GraphController.ts Klasse}, label={fig:on-timelines-to-handle}]
public class GraphController: MonoBehaviour
{
    ...
...
\begin{lstlisting}[caption={HandleTimelineManager aus GraphController.ts Klasse}, label={fig:handle-timeline-manager}]
public class GraphController: MonoBehaviour
{
    ...
...
\begin{lstlisting}[caption={Ausschnitt aus ReconstructionInteractionAbility.cs Klasse}, label={lst:reconstruction-interaction-ability}]
...
\begin{lstlisting}[caption={Ausschnitt aus CharacterController.cs Klasse}, label={lst:character-controller}]
...
\begin{lstlisting}[caption={Ausschnitt aus CharacterController.cs Klasse}, label={lst:character-controller_fixed}]
public class CharacterController : Controller
{
    ...
...
\begin{lstlisting}[caption={Ausschnitt aus Moveable.cs Klasse}, label={lst:moveable}]
