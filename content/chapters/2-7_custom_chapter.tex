...
Der Chronologe ist kein stiller Teilnehmer des Spiels. Sobald der Chronologe über Abgründe hinwegspringen muss, strengt ihn das an und er gibt einen angestrengten Laut von sich. Jeder Aktivität des Chronologen erzeugt seinen eigenen Laut. Zum Beispiel hört der Spieler die Fußstapfen, wenn der Chronologe sich bewegt oder aber ein raschelndes Geräusch Kleidung, sobald der Chronologe klettert oder einen Hebel umlegt.
...
Sobald das Spiel geladen hat, erscheint das in Abbildung \ref{fig:mainmenu}: \nameref{fig:mainmenu} zu sehende Startmenü des Spiels. Über das Startmenü kann der Spieler seinen aktuellen Spielstand fortsetzen, ein neues Spiel starten, die Einstellungen öffnen oder das Spiel wieder verlassen.
...
Im Folgenden wird auf die Umsetzung des entwickelten Prototyps eingegangen. Zunächst wird die Ausgangslage des Entwicklungsstands eingegangen. Dieser Entwicklungsstand beruht aus dem Endstand des Prototyps aus dem Gamedesign Workshop. Im Anschluss werden die verwendeten Packages in Unity vorgestellt. Danach folgt die Umsetzung des Prototyps in den vorgestellten Unterkapiteln.
...
Der $HandleTimelineManager$ ist die zentrale Loop, die das Replay-System ausführt. Durch die Anweisungen des $HandleTImelineManagers$ werden die richtigen Kopien des Chronologen erzeugt und ebenso die richtigen Interaktionen an die richtigen Kopien übergeben.
