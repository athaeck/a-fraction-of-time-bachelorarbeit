...
% \newpage
% ~
Sobald der Spieler ein Objekt trägt, erhält er wie in \say{Abbildung \ref{fig:carry_object_ui}} zu sehen eine Anweisung, wie er das Objekt wieder hinlegen kann. Das Objekt trägt er dabei, wie es in \say{Abbildung \ref{fig:carry_object_objectarm}} beim Spiel \say{The Talos Principle} zu sehen ist.
